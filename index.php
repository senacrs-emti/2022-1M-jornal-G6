...
<ul class="list-group" style="width:25% ;">
                <li class="list-group-item active" aria-current="true">Campeonatos</li>
                <li class="list-group-item"><img src="img/icon-article-ul-laliga-home.png" alt="">La Liga</li>
                <li class="list-group-item"><img src="img/icon-article-ul-ligue1-home.png" alt="">Ligue one</li>

                <li class="list-group-item"><img src="img/icon-article-ul-brasileirao-home.png" alt="">Brasileirão</li>
            ...
            <video style="width:65% ; position:relative; left:30%; top: -425px;" controls="">
